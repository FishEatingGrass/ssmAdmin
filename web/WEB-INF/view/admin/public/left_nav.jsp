                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="<%=request.getContextPath() %>${user.photo}" style="height: 64px;width: 64px;" /></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">${user.userName}-${user.trueName}</strong></span>
                                <span class="text-muted text-xs block">超级管理员<b class="caret"></b></span>
                                </span>
                            </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="<%=request.getContextPath() %>/admin/user/photo">修改头像</a>
                                </li>
                                <li><a class="J_menuItem" href="<%=request.getContextPath() %>/admin/user/edit">信息修改</a>
                                </li>
                                <li><a class="J_menuItem" href="contacts.html">联系我们</a>
                                </li>
                                <li class="divider"></li>
                                <li><a href="<%=request.getContextPath() %>/admin/login/out"">安全退出</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li>
                        <a href="<%=request.getContextPath() %>/admin/index/index"><i class="fa fa-home"></i><span class="nav-label">主页</span></a>
                    </li>
                    <li>
                        <a href="#">
                            <i class="fa fa-server"></i><span class="nav-label">权限管理</span><span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<%=request.getContextPath() %>/admin/rulegroup/index">规则分组</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<%=request.getContextPath() %>/admin/rule/index">规则列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<%=request.getContextPath() %>/admin/role/index">角色列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<%=request.getContextPath() %>/admin/user/index"">用户管理</a>
                            </li>
                        </ul>
                    </li>
