...
<body class="gray-bg">
    ...
    <script src="<%=request.getContextPath() %>/static/admin/js/plugins/flot/jquery.flot.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/demo/peity-demo.min.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/content.min.js?v=1.0.0"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="<%=request.getContextPath() %>/static/admin/js/demo/sparkline-demo.min.js"></script>
    <script>
